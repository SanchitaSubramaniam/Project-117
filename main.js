...
var random_number() {
    quick_draw_data_set=[quick_draw_data_set.length];
...
var sketch() {
    quick_draw_data_set = [random_number];
    document.getElementById('sketch_drawn').innerHTML = sketch();
}
...
function updateCanvas() {
    document.body.canvas.background = white;
    var random_number = math.floor(quick_draw_data_set);
    console.log(results);
    document.getElementById('timer').innerHTML = sketch();
}
